...
func TestAccesstokensIssueTemporaryAccessTokenWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/temporary-access-tokens")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["lookup", "resource_type"],
                    "properties": {
                        "lookup": {"type": "object", "additionalProperties": {"type": "string"}}, "resource_type": {"type": "string", "const": "company"}
                    },
                    "additionalProperties": true
                }`, "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"data": map[string]interface{}{"api_key_id": "api_key_id", "created_at": "2024-01-15T09:30:00Z", "environment_id": "environment_id", "expired_at": "2024-01-15T09:30:00Z", "id": "id", "resource_type": "resource_type", "token": "token", "updated_at": "2024-01-15T09:30:00Z"}, "params": map[string]interface{}{"key": "value"}},
	...
	_, invocationErr := client.Accesstokens.IssueTemporaryAccessToken(
		context.TODO(),
		request,
	)
