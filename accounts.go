...
type CreateAPIKeyRequestBody struct {
	...
	EnvironmentID *core.Optional[string] `json:"environment_id,omitempty" url:"-"`
...
type UpdateEnvironmentRequestBody struct {
	EnvironmentType *core.Optional[UpdateEnvironmentRequestBodyEnvironmentType] `json:"environment_type,omitempty" url:"-"`
	Name            *core.Optional[string]                                      `json:"name,omitempty" url:"-"`
}
