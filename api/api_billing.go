...
type BillingAPI interface {
	...
	/*
		...
		@return ApiCountBillingProductsRequest
	*/
	CountBillingProducts(ctx context.Context) ApiCountBillingProductsRequest

	// CountBillingProductsExecute executes the request
	//  @return CountBillingProductsResponse
	CountBillingProductsExecute(r ApiCountBillingProductsRequest) (*CountBillingProductsResponse, *http.Response, error)
...
type ApiCountBillingProductsRequest struct {
	ctx        context.Context
...
func (r ApiCountBillingProductsRequest) Ids(ids []string) ApiCountBillingProductsRequest {
	r.ids = &ids
	return r
}

func (r ApiCountBillingProductsRequest) Name(name string) ApiCountBillingProductsRequest {
	r.name = &name
	return r
}

func (r ApiCountBillingProductsRequest) Q(q string) ApiCountBillingProductsRequest {
	r.q = &q
	return r
}

// Page limit (default 100)
func (r ApiCountBillingProductsRequest) Limit(limit int32) ApiCountBillingProductsRequest {
	r.limit = &limit
	return r
}

// Page offset (default 0)
func (r ApiCountBillingProductsRequest) Offset(offset int32) ApiCountBillingProductsRequest {
	r.offset = &offset
	return r
}

func (r ApiCountBillingProductsRequest) Execute() (*CountBillingProductsResponse, *http.Response, error) {
	return r.ApiService.CountBillingProductsExecute(r)
}
...
CountBillingProducts Count billing products
	...
	@return ApiCountBillingProductsRequest
*/
func (a *BillingAPIService) CountBillingProducts(ctx context.Context) ApiCountBillingProductsRequest {
	return ApiCountBillingProductsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return CountBillingProductsResponse
func (a *BillingAPIService) CountBillingProductsExecute(r ApiCountBillingProductsRequest) (*CountBillingProductsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CountBillingProductsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BillingAPIService.CountBillingProducts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/billing/products/count"
