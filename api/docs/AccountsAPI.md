...
> CountApiRequestsResponse CountApiRequests(ctx).Q(q).Limit(limit).Offset(offset).Execute()
...
func main() {
	...
	resp, r, err := client.API().AccountsAPI.CountApiRequests(context.Background()).Q(q).Limit(limit).Offset(offset).Execute()
	if err != nil {
...
> ListApiRequestsResponse ListApiRequests(ctx).Q(q).Limit(limit).Offset(offset).Execute()
...
func main() {
	...
	resp, r, err := client.API().AccountsAPI.ListApiRequests(context.Background()).Q(q).Limit(limit).Offset(offset).Execute()
	if err != nil {
