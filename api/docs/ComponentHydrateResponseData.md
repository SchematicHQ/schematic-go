...
**UpcomingInvoice** | Pointer to [**InvoiceResponseData**](InvoiceResponseData.md) |  | [optional] 
...
GetUpcomingInvoice returns the UpcomingInvoice field if non-nil, zero value otherwise.

### GetUpcomingInvoiceOk

`func (o *ComponentHydrateResponseData) GetUpcomingInvoiceOk() (*InvoiceResponseData, bool)`

GetUpcomingInvoiceOk returns a tuple with the UpcomingInvoice field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetUpcomingInvoice sets UpcomingInvoice field to given value.
