...
// checks if the BillingInvoiceRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingInvoiceRequestBody{}

// BillingInvoiceRequestBody struct for BillingInvoiceRequestBody
type BillingInvoiceRequestBody struct {
...
type _BillingInvoiceRequestBody BillingInvoiceRequestBody
...
func NewBillingInvoiceRequestBody(amountDue int32, amountPaid int32, amountRemaining int32, collectionMethod string, currency string, customerExternalId string, subtotal int32) *BillingInvoiceRequestBody {
	this := BillingInvoiceRequestBody{}
...
func (o *BillingInvoiceRequestBody) SetCompanyIdNil() {
	o.CompanyId.Set(nil)
}
...
func (o *BillingInvoiceRequestBody) SetDueDateNil() {
	o.DueDate.Set(nil)
}
...
func (o *BillingInvoiceRequestBody) SetSubscriptionExternalIdNil() {
...
func (o BillingInvoiceRequestBody) MarshalJSON() ([]byte, error) {
...
func (o BillingInvoiceRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *BillingInvoiceRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varBillingInvoiceRequestBody := _BillingInvoiceRequestBody{}

	err = json.Unmarshal(data, &varBillingInvoiceRequestBody)

	if err != nil {
		return err
	}

	*o = BillingInvoiceRequestBody(varBillingInvoiceRequestBody)
...
type NullableBillingInvoiceRequestBody struct {
	value *BillingInvoiceRequestBody
	isSet bool
}

func (v NullableBillingInvoiceRequestBody) Get() *BillingInvoiceRequestBody {
	return v.value
}

func (v *NullableBillingInvoiceRequestBody) Set(val *BillingInvoiceRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingInvoiceRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingInvoiceRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingInvoiceRequestBody(val *BillingInvoiceRequestBody) *NullableBillingInvoiceRequestBody {
	return &NullableBillingInvoiceRequestBody{value: val, isSet: true}
}

func (v NullableBillingInvoiceRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingInvoiceRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
