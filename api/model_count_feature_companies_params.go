...
type _CountFeatureCompaniesParams CountFeatureCompaniesParams
...
func (o *CountFeatureCompaniesParams) UnmarshalJSON(data []byte) (err error) {
	varCountFeatureCompaniesParams := _CountFeatureCompaniesParams{}

	err = json.Unmarshal(data, &varCountFeatureCompaniesParams)

	if err != nil {
		return err
	}

	*o = CountFeatureCompaniesParams(varCountFeatureCompaniesParams)
