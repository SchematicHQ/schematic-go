...
// checks if the CountFlagsParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CountFlagsParams{}

// CountFlagsParams Input parameters
...
type _CountFlagsParams CountFlagsParams
...
func (o CountFlagsParams) MarshalJSON() ([]byte, error) {
...
func (o CountFlagsParams) ToMap() (map[string]interface{}, error) {
...
func (o *CountFlagsParams) UnmarshalJSON(data []byte) (err error) {
	varCountFlagsParams := _CountFlagsParams{}

	err = json.Unmarshal(data, &varCountFlagsParams)

	if err != nil {
		return err
	}

	*o = CountFlagsParams(varCountFlagsParams)
...
type NullableCountFlagsParams struct {
	value *CountFlagsParams
	isSet bool
}

func (v NullableCountFlagsParams) Get() *CountFlagsParams {
	return v.value
}

func (v *NullableCountFlagsParams) Set(val *CountFlagsParams) {
	v.value = val
	v.isSet = true
}

func (v NullableCountFlagsParams) IsSet() bool {
	return v.isSet
}

func (v *NullableCountFlagsParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCountFlagsParams(val *CountFlagsParams) *NullableCountFlagsParams {
	return &NullableCountFlagsParams{value: val, isSet: true}
}

func (v NullableCountFlagsParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCountFlagsParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
