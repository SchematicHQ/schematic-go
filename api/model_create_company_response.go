...
// checks if the CreateCompanyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCompanyResponse{}
...
func (o CreateCompanyResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CreateCompanyResponse) UnmarshalJSON(data []byte) (err error) {
