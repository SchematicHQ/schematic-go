...
type _DeleteApiKeyResponse DeleteApiKeyResponse
...
func (o *DeleteApiKeyResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteApiKeyResponse := _DeleteApiKeyResponse{}

	err = json.Unmarshal(data, &varDeleteApiKeyResponse)

	if err != nil {
		return err
	}

	*o = DeleteApiKeyResponse(varDeleteApiKeyResponse)
