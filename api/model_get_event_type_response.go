...
type _GetEventTypeResponse GetEventTypeResponse
...
func (o *GetEventTypeResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEventTypeResponse := _GetEventTypeResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEventTypeResponse)

	if err != nil {
		return err
	}

	*o = GetEventTypeResponse(varGetEventTypeResponse)
