...
type _GetFlagCheckResponse GetFlagCheckResponse
...
func (o *GetFlagCheckResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetFlagCheckResponse := _GetFlagCheckResponse{}

	err = json.Unmarshal(data, &varGetFlagCheckResponse)

	if err != nil {
		return err
	}

	*o = GetFlagCheckResponse(varGetFlagCheckResponse)
