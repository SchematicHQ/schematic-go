...
// checks if the GetLatestFlagChecksParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLatestFlagChecksParams{}
...
func NewGetLatestFlagChecksParams() *GetLatestFlagChecksParams {
	this := GetLatestFlagChecksParams{}
	return &this
}
...
func (o GetLatestFlagChecksParams) ToMap() (map[string]interface{}, error) {
...
type NullableGetLatestFlagChecksParams struct {
	value *GetLatestFlagChecksParams
	isSet bool
}

func (v NullableGetLatestFlagChecksParams) Get() *GetLatestFlagChecksParams {
	return v.value
}

func (v *NullableGetLatestFlagChecksParams) Set(val *GetLatestFlagChecksParams) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLatestFlagChecksParams) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLatestFlagChecksParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLatestFlagChecksParams(val *GetLatestFlagChecksParams) *NullableGetLatestFlagChecksParams {
	return &NullableGetLatestFlagChecksParams{value: val, isSet: true}
}

func (v NullableGetLatestFlagChecksParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLatestFlagChecksParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
