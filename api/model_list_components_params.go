...
// checks if the ListComponentsParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListComponentsParams{}

// ListComponentsParams Input parameters
...
func (o ListComponentsParams) MarshalJSON() ([]byte, error) {
...
func (o ListComponentsParams) ToMap() (map[string]interface{}, error) {
...
type NullableListComponentsParams struct {
	value *ListComponentsParams
	isSet bool
}

func (v NullableListComponentsParams) Get() *ListComponentsParams {
	return v.value
}

func (v *NullableListComponentsParams) Set(val *ListComponentsParams) {
	v.value = val
	v.isSet = true
}

func (v NullableListComponentsParams) IsSet() bool {
	return v.isSet
}

func (v *NullableListComponentsParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListComponentsParams(val *ListComponentsParams) *NullableListComponentsParams {
	return &NullableListComponentsParams{value: val, isSet: true}
}

func (v NullableListComponentsParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListComponentsParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
