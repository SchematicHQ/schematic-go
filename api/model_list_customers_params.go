...
// checks if the ListCustomersParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListCustomersParams{}

// ListCustomersParams Input parameters
...
type _ListCustomersParams ListCustomersParams
...
func (o ListCustomersParams) MarshalJSON() ([]byte, error) {
...
func (o ListCustomersParams) ToMap() (map[string]interface{}, error) {
...
func (o *ListCustomersParams) UnmarshalJSON(data []byte) (err error) {
	varListCustomersParams := _ListCustomersParams{}

	err = json.Unmarshal(data, &varListCustomersParams)

	if err != nil {
		return err
	}

	*o = ListCustomersParams(varListCustomersParams)
...
type NullableListCustomersParams struct {
	value *ListCustomersParams
	isSet bool
}

func (v NullableListCustomersParams) Get() *ListCustomersParams {
	return v.value
}

func (v *NullableListCustomersParams) Set(val *ListCustomersParams) {
	v.value = val
	v.isSet = true
}

func (v NullableListCustomersParams) IsSet() bool {
	return v.isSet
}

func (v *NullableListCustomersParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCustomersParams(val *ListCustomersParams) *NullableListCustomersParams {
	return &NullableListCustomersParams{value: val, isSet: true}
}

func (v NullableListCustomersParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCustomersParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
