...
// checks if the ListMetricCountsHourlyParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMetricCountsHourlyParams{}

// ListMetricCountsHourlyParams Input parameters
type ListMetricCountsHourlyParams struct {
...
func NewListMetricCountsHourlyParams() *ListMetricCountsHourlyParams {
	this := ListMetricCountsHourlyParams{}
	return &this
}
...
func (o ListMetricCountsHourlyParams) MarshalJSON() ([]byte, error) {
...
func (o ListMetricCountsHourlyParams) ToMap() (map[string]interface{}, error) {
...
type NullableListMetricCountsHourlyParams struct {
	value *ListMetricCountsHourlyParams
	isSet bool
}

func (v NullableListMetricCountsHourlyParams) Get() *ListMetricCountsHourlyParams {
	return v.value
}

func (v *NullableListMetricCountsHourlyParams) Set(val *ListMetricCountsHourlyParams) {
	v.value = val
	v.isSet = true
}

func (v NullableListMetricCountsHourlyParams) IsSet() bool {
	return v.isSet
}

func (v *NullableListMetricCountsHourlyParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListMetricCountsHourlyParams(val *ListMetricCountsHourlyParams) *NullableListMetricCountsHourlyParams {
	return &NullableListMetricCountsHourlyParams{value: val, isSet: true}
}

func (v NullableListMetricCountsHourlyParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListMetricCountsHourlyParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
