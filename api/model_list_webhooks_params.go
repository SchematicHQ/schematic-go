...
// checks if the ListWebhooksParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListWebhooksParams{}

// ListWebhooksParams Input parameters
...
func (o ListWebhooksParams) MarshalJSON() ([]byte, error) {
...
func (o ListWebhooksParams) ToMap() (map[string]interface{}, error) {
...
type NullableListWebhooksParams struct {
	value *ListWebhooksParams
	isSet bool
}

func (v NullableListWebhooksParams) Get() *ListWebhooksParams {
	return v.value
}

func (v *NullableListWebhooksParams) Set(val *ListWebhooksParams) {
	v.value = val
	v.isSet = true
}

func (v NullableListWebhooksParams) IsSet() bool {
	return v.isSet
}

func (v *NullableListWebhooksParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWebhooksParams(val *ListWebhooksParams) *NullableListWebhooksParams {
	return &NullableListWebhooksParams{value: val, isSet: true}
}

func (v NullableListWebhooksParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWebhooksParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
