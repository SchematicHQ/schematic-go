...
// checks if the PaymentMethodResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentMethodResponseData{}
...
type _PaymentMethodResponseData PaymentMethodResponseData
...
func (o *PaymentMethodResponseData) SetCardBrandNil() {
	o.CardBrand.Set(nil)
}
...
func (o *PaymentMethodResponseData) SetCardExpMonthNil() {
...
func (o *PaymentMethodResponseData) SetCardExpYearNil() {
...
func (o *PaymentMethodResponseData) SetCardLast4Nil() {
	o.CardLast4.Set(nil)
}
...
func (o *PaymentMethodResponseData) SetCompanyIdNil() {
	o.CompanyId.Set(nil)
}
...
func (o *PaymentMethodResponseData) SetInvoiceExternalIdNil() {
...
func (o *PaymentMethodResponseData) SetSubscriptionExternalIdNil() {
...
func (o PaymentMethodResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentMethodResponseData) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentMethodResponseData := _PaymentMethodResponseData{}

	err = json.Unmarshal(data, &varPaymentMethodResponseData)

	if err != nil {
		return err
	}

	*o = PaymentMethodResponseData(varPaymentMethodResponseData)
