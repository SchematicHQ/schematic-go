...
type _UpdateCompanyOverrideRequestBody UpdateCompanyOverrideRequestBody
...
func (o *UpdateCompanyOverrideRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateCompanyOverrideRequestBody := _UpdateCompanyOverrideRequestBody{}

	err = json.Unmarshal(data, &varUpdateCompanyOverrideRequestBody)

	if err != nil {
		return err
	}

	*o = UpdateCompanyOverrideRequestBody(varUpdateCompanyOverrideRequestBody)
