...
func TestCheckoutInternalWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/checkout-internal")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"data": map[string]interface{}{"cancel_at": 1, "cancel_at_period_end": true, "company_id": "company_id", "confirm_payment_intent_client_secret": "confirm_payment_intent_client_secret", "confirm_payment_intent_id": "confirm_payment_intent_id", "created_at": "2024-01-15T09:30:00Z", "currency": "currency", "customer_external_id": "customer_external_id", "default_payment_method_id": "default_payment_method_id", "expired_at": "2024-01-15T09:30:00Z", "id": "id", "interval": "interval", "metadata": map[string]interface{}{"key": "value"}, "period_end": 1, "period_start": 1, "status": "status", "subscription_external_id": "subscription_external_id", "total_price": 1, "trial_end": 1, "trial_end_setting": "trial_end_setting"}, "params": map[string]interface{}{"key": "value"}},
	...
	_, invocationErr := client.Checkout.Internal(
		context.TODO(),
		request,
	)
...
func TestCheckoutGetCheckoutDataWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/checkout-internal/data")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
	...
	_, invocationErr := client.Checkout.GetCheckoutData(
		context.TODO(),
		request,
	)
...
func TestCheckoutPreviewCheckoutInternalWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/checkout-internal/preview")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"data": map[string]interface{}{"amount_off": 1, "due_now": 1, "finance": map[string]interface{}{"amount_off": 1, "due_now": 1, "new_charges": 1, "percent_off": 1.1, "period_start": "2024-01-15T09:30:00Z", "promo_code_applied": true, "proration": 1, "tax_amount": 1, "tax_display_name": "tax_display_name", "tax_require_billing_details": true, "trial_end": "2024-01-15T09:30:00Z", "upcoming_invoice_line_items": []interface{}{map[string]interface{}{"amount": 1, "description": "description", "price_id": "price_id", "proration": true, "quantity": 1}}}, "new_charges": 1, "payment_method_required": true, "percent_off": 1.1, "period_start": "2024-01-15T09:30:00Z", "promo_code_applied": true, "proration": 1, "usage_violations": []interface{}{map[string]interface{}{"access": true, "allocation_type": "boolean", "entitlement_id": "entitlement_id", "entitlement_type": "entitlement_type"}}}, "params": map[string]interface{}{"key": "value"}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
	...
	_, invocationErr := client.Checkout.PreviewCheckoutInternal(
		context.TODO(),
		request,
	)
...
func TestCheckoutManagePlanWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/manage-plan")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"data": map[string]interface{}{"company": map[string]interface{}{"add_ons": []interface{}{map[string]interface{}{"id": "id", "name": "name"}}, "billing_credit_balances": map[string]interface{}{"key": 1.1}, "billing_subscription": map[string]interface{}{"cancel_at_period_end": true, "created_at": "2024-01-15T09:30:00Z", "currency": "currency", "customer_external_id": "customer_external_id", "discounts": []interface{}{map[string]interface{}{"coupon_id": "coupon_id", "coupon_name": "coupon_name", "discount_external_id": "discount_external_id", "duration": "duration", "is_active": true, "started_at": "2024-01-15T09:30:00Z", "subscription_external_id": "subscription_external_id"}}, "id": "id", "interval": "interval", "period_end": 1, "period_start": 1, "products": []interface{}{map[string]interface{}{"billing_scheme": "billing_scheme", "created_at": "2024-01-15T09:30:00Z", "currency": "currency", "environment_id": "environment_id", "external_id": "external_id", "id": "id", "interval": "interval", "name": "name", "package_size": 1, "price": 1, "price_external_id": "price_external_id", "price_id": "price_id", "price_tier": []interface{}{map[string]interface{}{}}, "quantity": 1.1, "subscription_id": "subscription_id", "updated_at": "2024-01-15T09:30:00Z", "usage_type": "usage_type"}}, "status": "status", "subscription_external_id": "subscription_external_id", "total_price": 1}, "billing_subscriptions": []interface{}{map[string]interface{}{"cancel_at_period_end": true, "created_at": "2024-01-15T09:30:00Z", "currency": "currency", "customer_external_id": "customer_external_id", "discounts": []interface{}{map[string]interface{}{"coupon_id": "coupon_id", "coupon_name": "coupon_name", "discount_external_id": "discount_external_id", "duration": "duration", "is_active": true, "started_at": "2024-01-15T09:30:00Z", "subscription_external_id": "subscription_external_id"}}, "id": "id", "interval": "interval", "period_end": 1, "period_start": 1, "products": []interface{}{map[string]interface{}{"billing_scheme": "billing_scheme", "created_at": "2024-01-15T09:30:00Z", "currency": "currency", "environment_id": "environment_id", "external_id": "external_id", "id": "id", "interval": "interval", "name": "name", "package_size": 1, "price": 1, "price_external_id": "price_external_id", "price_id": "price_id", "price_tier": []interface{}{map[string]interface{}{}}, "quantity": 1.1, "subscription_id": "subscription_id", "updated_at": "2024-01-15T09:30:00Z", "usage_type": "usage_type"}}, "status": "status", "subscription_external_id": "subscription_external_id", "total_price": 1}}, "created_at": "2024-01-15T09:30:00Z", "default_payment_method": map[string]interface{}{"created_at": "2024-01-15T09:30:00Z", "customer_external_id": "customer_external_id", "environment_id": "environment_id", "external_id": "external_id", "id": "id", "payment_method_type": "payment_method_type", "updated_at": "2024-01-15T09:30:00Z"}, "entity_traits": []interface{}{map[string]interface{}{"created_at": "2024-01-15T09:30:00Z", "definition_id": "definition_id", "environment_id": "environment_id", "id": "id", "updated_at": "2024-01-15T09:30:00Z", "value": "value"}}, "environment_id": "environment_id", "id": "id", "keys": []interface{}{map[string]interface{}{"created_at": "2024-01-15T09:30:00Z", "definition_id": "definition_id", "entity_id": "entity_id", "entity_type": "entity_type", "environment_id": "environment_id", "id": "id", "key": "key", "updated_at": "2024-01-15T09:30:00Z", "value": "value"}}, "last_seen_at": "2024-01-15T09:30:00Z", "logo_url": "logo_url", "metrics": []interface{}{map[string]interface{}{"account_id": "account_id", "captured_at_max": "2024-01-15T09:30:00Z", "captured_at_min": "2024-01-15T09:30:00Z", "company_id": "company_id", "created_at": "2024-01-15T09:30:00Z", "environment_id": "environment_id", "event_subtype": "event_subtype", "month_reset": "month_reset", "period": "period", "value": 1}}, "name": "name", "payment_methods": []interface{}{map[string]interface{}{"created_at": "2024-01-15T09:30:00Z", "customer_external_id": "customer_external_id", "environment_id": "environment_id", "external_id": "external_id", "id": "id", "payment_method_type": "payment_method_type", "updated_at": "2024-01-15T09:30:00Z"}}, "plan": map[string]interface{}{"id": "id", "name": "name"}, "plans": []interface{}{map[string]interface{}{"id": "id", "name": "name"}}, "rules": []interface{}{map[string]interface{}{"account_id": "account_id", "condition_groups": []interface{}{map[string]interface{}{"conditions": []interface{}{map[string]interface{}{"account_id": "account_id", "condition_type": "base_plan", "environment_id": "environment_id", "id": "id", "operator": "eq", "resource_ids": []interface{}{"resource_ids"}, "trait_value": "trait_value"}}}}, "conditions": []interface{}{map[string]interface{}{"account_id": "account_id", "condition_type": "base_plan", "environment_id": "environment_id", "id": "id", "operator": "eq", "resource_ids": []interface{}{"resource_ids"}, "trait_value": "trait_value"}}, "environment_id": "environment_id", "id": "id", "name": "name", "priority": 1, "rule_type": "default", "value": true}}, "traits": map[string]interface{}{"key": "value"}, "updated_at": "2024-01-15T09:30:00Z", "user_count": 1}, "success": true}, "params": map[string]interface{}{"key": "value"}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
	...
	_, invocationErr := client.Checkout.ManagePlan(
		context.TODO(),
		request,
	)
...
func TestCheckoutPreviewManagePlanWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/manage-plan/preview")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"data": map[string]interface{}{"subscription_change_preview": map[string]interface{}{"amount_off": 1, "due_now": 1, "finance": map[string]interface{}{"amount_off": 1, "due_now": 1, "new_charges": 1, "percent_off": 1.1, "period_start": "2024-01-15T09:30:00Z", "promo_code_applied": true, "proration": 1, "tax_require_billing_details": true, "upcoming_invoice_line_items": []interface{}{map[string]interface{}{"amount": 1, "description": "description", "price_id": "price_id", "proration": true, "quantity": 1}}}, "new_charges": 1, "payment_method_required": true, "percent_off": 1.1, "period_start": "2024-01-15T09:30:00Z", "promo_code_applied": true, "proration": 1, "usage_violations": []interface{}{map[string]interface{}{"access": true, "allocation_type": "boolean", "entitlement_id": "entitlement_id", "entitlement_type": "entitlement_type"}}}}, "params": map[string]interface{}{"key": "value"}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
	...
	_, invocationErr := client.Checkout.PreviewManagePlan(
		context.TODO(),
		request,
	)
...
func TestCheckoutUpdateCustomerSubscriptionTrialEndWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/subscription/{subscription_id}/edit-trial-end")).WithPathParam(
		"subscription_id",
		gowiremock.Matching("subscription_id"),
	...
	_, invocationErr := client.Checkout.UpdateCustomerSubscriptionTrialEnd(
		context.TODO(),
		"subscription_id",
		request,
	)
