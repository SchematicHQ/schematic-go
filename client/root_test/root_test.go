...
func TestPutPlanAudiencesPlanAudienceIDWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/plan-audiences/{plan_audience_id}")).WithPathParam(
		"plan_audience_id",
		gowiremock.Matching("plan_audience_id"),
	).WillReturnResponse(
	...
	invocationErr := client.PutPlanAudiencesPlanAudienceID(
		context.TODO(),
		"plan_audience_id",
	)
...
func TestDeletePlanAudiencesPlanAudienceIDWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/plan-audiences/{plan_audience_id}")).WithPathParam(
		"plan_audience_id",
		gowiremock.Matching("plan_audience_id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
	...
	invocationErr := client.DeletePlanAudiencesPlanAudienceID(
		context.TODO(),
		"plan_audience_id",
	)
