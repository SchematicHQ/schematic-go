...
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BillingProductPriceResponseData) SetBillingScheme(billingScheme string) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (b *BillingProductPriceResponseData) SetUsageType(usageType string) {
...
type CompanyPlanDetailResponseData struct {
	...
	InvalidReason        *CompanyPlanDetailResponseDataInvalidReason `json:"invalid_reason,omitempty" url:"invalid_reason,omitempty"`
...
func (c *CompanyPlanDetailResponseData) GetInvalidReason() *CompanyPlanDetailResponseDataInvalidReason {
	if c == nil {
		return nil
	}
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CompanyPlanDetailResponseData) SetInvalidReason(invalidReason *CompanyPlanDetailResponseDataInvalidReason) {
...
type CompanyPlanDetailResponseDataInvalidReason string

const (
	CompanyPlanDetailResponseDataInvalidReasonFeatureUsageExceeded  CompanyPlanDetailResponseDataInvalidReason = "feature_usage_exceeded"
	CompanyPlanDetailResponseDataInvalidReasonDowngradeNotPermitted CompanyPlanDetailResponseDataInvalidReason = "downgrade_not_permitted"
)

func NewCompanyPlanDetailResponseDataInvalidReasonFromString(s string) (CompanyPlanDetailResponseDataInvalidReason, error) {
	switch s {
	case "feature_usage_exceeded":
		return CompanyPlanDetailResponseDataInvalidReasonFeatureUsageExceeded, nil
	case "downgrade_not_permitted":
		return CompanyPlanDetailResponseDataInvalidReasonDowngradeNotPermitted, nil
	}
	var t CompanyPlanDetailResponseDataInvalidReason
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (c CompanyPlanDetailResponseDataInvalidReason) Ptr() *CompanyPlanDetailResponseDataInvalidReason {
	return &c
}
...
var (
	...
	componentPreviewResponseDataFieldFeatureUsage                          = big.NewInt(1 << 11)
	componentPreviewResponseDataFieldInvoices                              = big.NewInt(1 << 12)
	componentPreviewResponseDataFieldPostTrialPlan                         = big.NewInt(1 << 13)
	componentPreviewResponseDataFieldPreventSelfServiceDowngrade           = big.NewInt(1 << 14)
	componentPreviewResponseDataFieldPreventSelfServiceDowngradeButtonText = big.NewInt(1 << 15)
	componentPreviewResponseDataFieldPreventSelfServiceDowngradeURL        = big.NewInt(1 << 16)
	componentPreviewResponseDataFieldShowCredits                           = big.NewInt(1 << 17)
	componentPreviewResponseDataFieldShowPeriodToggle                      = big.NewInt(1 << 18)
	componentPreviewResponseDataFieldShowZeroPriceAsFree                   = big.NewInt(1 << 19)
	componentPreviewResponseDataFieldStripeEmbed                           = big.NewInt(1 << 20)
	componentPreviewResponseDataFieldSubscription                          = big.NewInt(1 << 21)
	componentPreviewResponseDataFieldTrialPaymentMethodRequired            = big.NewInt(1 << 22)
	componentPreviewResponseDataFieldUpcomingInvoice                       = big.NewInt(1 << 23)
)
