...
type CreateCrmDealRequestBody struct {
	Arr            *core.Optional[string] `json:"arr,omitempty" url:"-"`
	CrmCompanyID   *core.Optional[string] `json:"crm_company_id,omitempty" url:"-"`
	CrmCompanyKey  string                 `json:"crm_company_key" url:"-"`
	CrmProductID   *core.Optional[string] `json:"crm_product_id,omitempty" url:"-"`
	CrmType        string                 `json:"crm_type" url:"-"`
	DealExternalID string                 `json:"deal_external_id" url:"-"`
	DealName       *core.Optional[string] `json:"deal_name,omitempty" url:"-"`
	DealStage      *core.Optional[string] `json:"deal_stage,omitempty" url:"-"`
	Mrr            *core.Optional[string] `json:"mrr,omitempty" url:"-"`
}
...
type CreateCrmLineItemRequestBody struct {
	TermMonth          *core.Optional[int]    `json:"TermMonth,omitempty" url:"-"`
	Amount             string                 `json:"amount" url:"-"`
	DiscountPercentage *core.Optional[string] `json:"discount_percentage,omitempty" url:"-"`
	Interval           string                 `json:"interval" url:"-"`
	LineItemExternalID string                 `json:"line_item_external_id" url:"-"`
	ProductExternalID  string                 `json:"product_external_id" url:"-"`
	Quantity           int                    `json:"quantity" url:"-"`
	TotalDiscount      *core.Optional[string] `json:"total_discount,omitempty" url:"-"`
}
