...
type CreateCompanyOverrideRequestBody struct {
	...
	MetricPeriod *core.Optional[CreateCompanyOverrideRequestBodyMetricPeriod] `json:"metric_period,omitempty" url:"-"`
	ValueBool    *core.Optional[bool]                                         `json:"value_bool,omitempty" url:"-"`
	ValueNumeric *core.Optional[int]                                          `json:"value_numeric,omitempty" url:"-"`
	ValueTraitID *core.Optional[string]                                       `json:"value_trait_id,omitempty" url:"-"`
	ValueType    CreateCompanyOverrideRequestBodyValueType                    `json:"value_type" url:"-"`
}

type CreatePlanEntitlementRequestBody struct {
	FeatureID    string                                                       `json:"feature_id" url:"-"`
	MetricPeriod *core.Optional[CreatePlanEntitlementRequestBodyMetricPeriod] `json:"metric_period,omitempty" url:"-"`
...
type UpdateCompanyOverrideRequestBody struct {
	MetricPeriod *core.Optional[UpdateCompanyOverrideRequestBodyMetricPeriod] `json:"metric_period,omitempty" url:"-"`
	ValueBool    *core.Optional[bool]                                         `json:"value_bool,omitempty" url:"-"`
	ValueNumeric *core.Optional[int]                                          `json:"value_numeric,omitempty" url:"-"`
	ValueTraitID *core.Optional[string]                                       `json:"value_trait_id,omitempty" url:"-"`
...
type UpdatePlanEntitlementRequestBody struct {
	MetricPeriod *core.Optional[UpdatePlanEntitlementRequestBodyMetricPeriod] `json:"metric_period,omitempty" url:"-"`
	ValueBool    *core.Optional[bool]                                         `json:"value_bool,omitempty" url:"-"`
	ValueNumeric *core.Optional[int]                                          `json:"value_numeric,omitempty" url:"-"`
	ValueTraitID *core.Optional[string]                                       `json:"value_trait_id,omitempty" url:"-"`
