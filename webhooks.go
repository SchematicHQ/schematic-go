...
type UpdateWebhookRequestBody struct {
	...
	RequestTypes *core.Optional[[]UpdateWebhookRequestBodyRequestTypesItem] `json:"request_types,omitempty" url:"-"`
	Status       *core.Optional[UpdateWebhookRequestBodyStatus]             `json:"status,omitempty" url:"-"`
